    ...
    return (
        <footer className="w-full bg-pink-600 text-white py-8 px-4">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
                ...
                {/* Navegación */}
                <nav className="flex flex-col md:flex-row md:space-x-8 text-center md:text-left gap-4 md:gap-0 text-lg font-[Open_Sans]">
                    <Link to="/sobrenosotros" className="hover:text-pink-200">Sobre Nosotros</Link>
                    <Link to="/productos" className="hover:text-pink-200">Productos</Link>
                    <Link to="/servicios" className="hover:text-pink-200">Servicios</Link>
                    <a href="#" className="hover:text-pink-200">Contacto</a>
                </nav>
